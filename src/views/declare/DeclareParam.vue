<template>
  <div style="width:1000px; height:400px; background: #fff; margin: 0 auto; ">
    <el-container
      style="width:100%; height:100%; padding:15px; box-sizing:border-box; text-align:left;"
    >
    ...
    >
      ...
      >
        ...
        <el-form-item label="参数名称" prop="paramName">
          <el-input
            v-model="declareParam.paramName"
            auto-complete="off"
        ...
        <el-form-item label="参数数据类型" prop="paramDataType">
          <el-input
            v-model="declareParam.paramDataType"
            auto-complete="off"
            suffix-icon="el-icon-edit"
            placeholder="请输入参数数据类型"
          ></el-input>
        </el-form-item>
        <el-form-item label="辅助信息" prop="assistInfo">
          <el-input
            v-model="declareParam.assistInfo"
            auto-complete="off"
            suffix-icon="el-icon-edit"
            placeholder="请输入辅助信息"
          ></el-input>
        ...
        <el-form-item label="是否公告" prop="isDeclare">
          <el-input
            v-model="declareParam.isDeclare"
            auto-complete="off"
            suffix-icon="el-icon-edit"
            placeholder="请输入是或否"
          ></el-input>
        ...
        <el-form-item label="所属市场" prop="ruleSence">
          <el-input
            v-model="declareParam.ruleSence"
            auto-complete="off"
            disabled
            suffix-icon="el-icon-star-on"
          ></el-input>
