  ...
  <div style="width:1000px; height:400px; background: #fff; margin: 0 auto;">
      <el-container style="width:100%; height:100%; padding:15px; box-sizing:border-box; text-align:left;">
        ...
        <el-main style="width: 100%; height:255px; padding-bottom:10px;">
          <el-table :data="declareInfoList" height="240px" bodrder stripe   @selection-change="handleSelectionChange"  style="font-size:12px;">
            ...
            <el-table-column prop="ruleType" label="规则类型"  width="150" align="center"></el-table-column>
            <el-table-column prop="ruleUser" label="规则应用方"  width="150" align="center"></el-table-column>
      ...
      <el-dialog
        ...
        <el-form :model="declareInfo" :label-position="labelPosition" label-width="100px" size="mini" :rules="rules" ref="declareInfo"> 
          <el-form-item label="规则名称" prop="ruleName">
            <el-input v-model="declareInfo.ruleName" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="规则编码" prop="ruleCode">
            <el-input v-model="declareInfo.ruleCode" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="规则类型" prop="ruleType">
            <el-input v-model="declareInfo.ruleType" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="规则应用方" prop="ruleUser">
            <el-input v-model="declareInfo.ruleUser" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="规则场景" prop="ruleSence">
            <el-input v-model="declareInfo.ruleSence" auto-complete="off"></el-input>
          </el-form-item>
          
        </el-form>
        <span slot="footer" class="dialog-footer" >
          <el-button type="danger" size="small" @click="declareInfoDialogVisible = false">取 消</el-button>
          <el-button type="primary" size="small"  @click="save('declareInfo')">确 定</el-button>
        </span>
      </el-dialog>
